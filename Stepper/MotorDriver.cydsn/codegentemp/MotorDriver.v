...
module SCB_P4_v3_0_0 (
	...
	cy_clock_v1_0
		#(.id("527db02b-187b-4934-b369-74c9e02f535d/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("527db02b-187b-4934-b369-74c9e02f535d/5382e105-1382-4a2e-b9f4-3bb2feba71e0"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("527db02b-187b-4934-b369-74c9e02f535d/22863ebe-a37b-476f-b252-6e49a8c00b12"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module SCB_P4_v3_0_1 (
	...
	cy_clock_v1_0
		#(.id("1563e652-0e7f-4773-ad0a-6f6c9c571b60/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1563e652-0e7f-4773-ad0a-6f6c9c571b60/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1563e652-0e7f-4773-ad0a-6f6c9c571b60/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module ADC_SAR_SEQ_P4_v2_20_2 (
	...
	cy_clock_v1_0
		#(.id("2a14be5e-e101-4c71-b9de-1954070fc86c/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("250000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Current_net;
	wire [0:0] tmpFB_0__Current_net;
	wire [0:0] tmpIO_0__Current_net;
	wire [0:0] tmpINTERRUPT_0__Current_net;
	electrical [0:0] tmpSIOVREF__Current_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Current
		 (.oe(tmpOE__Current_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Current_net[0:0]}),
		  .analog({Net_61}),
		  .io({tmpIO_0__Current_net[0:0]}),
		  .siovref(tmpSIOVREF__Current_net),
		  .interrupt({tmpINTERRUPT_0__Current_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Current_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("816e5c52-1217-41d5-92bd-fb9ee9d1ba16"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__PWM_AB_net;
	wire [0:0] tmpFB_0__PWM_AB_net;
	wire [0:0] tmpIO_0__PWM_AB_net;
	wire [0:0] tmpINTERRUPT_0__PWM_AB_net;
	electrical [0:0] tmpSIOVREF__PWM_AB_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_AB
		 (.oe(tmpOE__PWM_AB_net),
		  .y({Net_207}),
		  .fb({tmpFB_0__PWM_AB_net[0:0]}),
		  .io({tmpIO_0__PWM_AB_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_AB_net),
		  .interrupt({tmpINTERRUPT_0__PWM_AB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_AB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWM_CD_net;
	wire [0:0] tmpFB_0__PWM_CD_net;
	wire [0:0] tmpIO_0__PWM_CD_net;
	wire [0:0] tmpINTERRUPT_0__PWM_CD_net;
	electrical [0:0] tmpSIOVREF__PWM_CD_net;

	cy_psoc3_pins_v1_10
		#(.id("50ed5f0b-0610-4ba3-b70b-af381366fd2e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_CD
		 (.oe(tmpOE__PWM_CD_net),
		  .y({Net_226}),
		  .fb({tmpFB_0__PWM_CD_net[0:0]}),
		  .io({tmpIO_0__PWM_CD_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_CD_net),
		  .interrupt({tmpINTERRUPT_0__PWM_CD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_CD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
